...
> **Note:** If you want to run Vite directly, use `node node_modules/vite/bin/vite.js build`,
> `npm exec -- vite build`, or `npx vite build` (or install Vite globally). Running
> `vite build` without those requires `vite` to be on your PATH.
